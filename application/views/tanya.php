		...
		<div class="container">
	  		<div class="row">
		  		<div class="col s12" style="padding-top:20px;">
		        	...
		        	<a href="<?php echo base_url(); ?>" class="breadcrumb black-text">Tanya Profesional</a>
		      	</div>
		  		<h3 class="center header title-cust">Tanya Profesional</h3>
		  		<div class="col s12 m12">
						...
						<?php foreach ($profesional as $key) : ?>
				          ...
				          <div class="row valign-wrapper">
				            ...
				            <div class="col s7">
				              ...
				              <span class="black-text">
				                <p><?php echo $key['JOB']; ?></p>	
				              </span>
				            </div>
				            <div class="col s3">
				            	<div class="new green white-text center" style="padding:15px 10px;margin-bottom:10px;">Menerima pasien</div>
				            	<a class="white-text" href="<?php echo base_url('profil/index'); ?>/<?php echo $key['ID']; ?>"><div class="new  deep-purple lighten-1 center" style="padding:15px 10px;">Lihat Profil</div></a>
				            </div>
				          </div>
				        </div>
			    		<?php endforeach; ?>
